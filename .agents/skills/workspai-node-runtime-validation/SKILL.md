---
name: workspai-node-runtime-validation
description: "NODE runtime validation through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-node-runtime-validation.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
