---
name: workspai-safe-schema-migration
description: "Safe schema migration through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-safe-schema-migration.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
