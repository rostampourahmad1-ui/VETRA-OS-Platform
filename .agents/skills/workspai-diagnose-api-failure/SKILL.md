---
name: workspai-diagnose-api-failure
description: "Diagnose API failure through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-diagnose-api-failure.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
