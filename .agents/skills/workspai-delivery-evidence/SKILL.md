---
name: workspai-delivery-evidence
description: "Delivery evidence and CI recovery through the Workspai project intelligence contract"
---

<!-- WORKSPAI:GENERATED-PROJECT-SKILL -->

# Delivery evidence and CI recovery
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-delivery-evidence.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
