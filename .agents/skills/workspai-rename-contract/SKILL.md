---
name: workspai-rename-contract
description: "Rename contract safely through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-rename-contract.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
