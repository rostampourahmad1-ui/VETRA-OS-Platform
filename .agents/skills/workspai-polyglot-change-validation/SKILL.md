---
name: workspai-polyglot-change-validation
description: "Polyglot change validation through the Workspai project intelligence contract"
---

<!-- WORKSPAI:GENERATED-PROJECT-SKILL -->

# Polyglot change validation
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-polyglot-change-validation.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
