---
name: workspai-bun-runtime-validation
description: "BUN runtime validation through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-bun-runtime-validation.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
