---
name: workspai-release-readiness
description: "Release readiness through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-release-readiness.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
