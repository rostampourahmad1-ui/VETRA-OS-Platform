---
name: workspai-dependency-upgrade
description: "Dependency upgrade through the Workspai project intelligence contract"
---
...
4. Resolve and follow the canonical Skill `workspace:.workspai/skills/workspai-dependency-upgrade.md` listed in `workspace:.workspai/reports/workspace-skills-index.json`.
